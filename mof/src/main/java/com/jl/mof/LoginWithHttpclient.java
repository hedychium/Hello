...
public class LoginWithHttpclient {
	...
	public static void setCookieStore(HttpResponse httpResponse) {
		...
		BasicClientCookie cookie = new BasicClientCookie("JSESSIONID",
				JSESSIONID);
		cookie.setVersion(0);
		cookie.setDomain("momrpt-ci.wmcloud-qa.com");
		cookie.setPath("/finbook/v2");
	 ...
	 * @return
	 */
	public static HttpResponse doPost2(String postUrl, Map<String, Object> map,
			String charset) {
		String retStr = "";
		// 创建HttpClientBuilder
		...
		if (cookieStore != null) {
			httpClient = httpClientBuilder.setDefaultCookieStore(cookieStore)
					.build();
		} else {
	...
	public static String doPost(String postUrl, Map<String, Object> params,
		...
		if (cookieStore != null) {
			closeableHttpClient = httpClientBuilder.setDefaultCookieStore(
					cookieStore).build();
		} else {
	...
	public static void main(String[] args) {
		...
		String re = HttpRequestUtils
				.sendWithFile2(
						cookieStore,cookie,
						"http://momrpt-ci.wmcloud-qa.com/finbook/v2/api/report/65058/upload",
						filePath);
