...
public class testRumor {
	...
	public static void main(String[] args) {
        ...
        try {
			...
			try {
	           ...
	           // String sql = "SELECT NEWS_ID FROM bigdata.stock_news_tag where IS_RUMOUR=1 and date_format(NEWS_EFFECTIVE_TIME,'%Y-%m-%d')  between '2018-07-17' and '2018-07-17'";
	            String sql = "SELECT NEWS_ID FROM bigdata.stock_news_tag where IS_ANNOUNCEMENT=1 and date_format(NEWS_EFFECTIVE_TIME,'%Y-%m-%d')  between '2018-07-20' and '2018-07-20' limit 50";
      ...
      //将文件保存到指定的位置
        try {
            FileOutputStream fos = new FileOutputStream("./File/Annews.xlsx");
            workbook.write(fos);
